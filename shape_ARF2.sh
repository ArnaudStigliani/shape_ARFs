...
time python2.7 $path_DNAshape/DNAshapedTFBS.py trainPSSM -f ../results/files_mono/ARF2.jaspar \
    -i ../results/files_mono/ARF2_top.fasta -I ../results/files_mono/ARF2_top_regions.bed \
    -b ../results/files_mono/ARF2_top_neg.fasta -B ../results/files_mono/ARF2_top_regions_1_neg.bed \
    -o ../results/files_mono/DNAshapedPSSM_classifier_ARF2 \
    -1 $helt $prot $mgw $roll -2 $helt2 $prot2 $mgw2 $roll2 -n;
...
# echo "Applying the trained first order TFFM + DNA shape classifier on ../results/files_mono sequences.";
# time python2.7 ../DNAshapedTFBS.py applyTFFM -T TFFM_first_order.xml \
#     -i ../results/files_mono/test.fa -I ../results/files_mono/test.bed \
#     -c DNAshapedTFFM_fo_classifier.pkl -o DNAshapedTFFM_fo_fg_predictions.txt \
#     -1 $helt $prot $mgw $roll -2 $helt2 $prot2 $mgw2 $roll2 -n;

# echo "Applying the trained detailed TFFM + DNA shape classifier on ../results/files_mono sequences.";
...
time python2.7 $path_DNAshape/DNAshapedTFBS.py applyPSSM -f ../results/files_mono/ARF2.jaspar \
    -i ../results/files_mono/ARF2_test.fas -I ../results/files_mono/ARF2_test.bed \
    -c ../results/files_mono/DNAshapedPSSM_classifier_ARF2.pkl -o ../results/files_mono/DNAshapedPSSM_fg_predictions_ARF2.txt \
    -v 0 \
    -1 $helt $prot $mgw $roll -2 $helt2 $prot2 $mgw2 $roll2 -n;

# echo "Applying the trained 4-bits + DNA shape classifier on ../results/files_mono sequences.";
...
time python2.7 $path_DNAshape/DNAshapedTFBS.py applyPSSM -f ../results/files_mono/ARF2.jaspar \
    ...
    -c ../results/files_mono/DNAshapedPSSM_classifier_ARF2.pkl -o ../results/files_mono/DNAshapedPSSM_bg_predictions_ARF2.txt \
    -v 0 \
    -1 $helt $prot $mgw $roll -2 $helt2 $prot2 $mgw2 $roll2 -n;
